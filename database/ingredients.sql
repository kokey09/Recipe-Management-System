...
*/
USE recipedb;
INSERT INTO `ingredients` (`ingredient_id`,`name`,`description`) VALUES (1,'Chicken','fasd');
INSERT INTO `ingredients` (`ingredient_id`,`name`,`description`) VALUES (2,'Rice ','afdsa');
INSERT INTO `ingredients` (`ingredient_id`,`name`,`description`) VALUES (3,'Egg ','fasd');
INSERT INTO `ingredients` (`ingredient_id`,`name`,`description`) VALUES (4,'Pork   ','fsad');
